...
var  ESTADOREQ = { INICIAL:0, AUTENTICADO:10 , RESPUESTADESCONOCIDA:99, RECIBIDO:1,ERROR:500,ACEPTADO:5000,REQUIRIENDO:2,TOKENINVALIDO:300,VERIFICANDO:5001};  /* Estado del requerimiento */
var  TOKEN = { TIMELIVE : 5 }   // tiempo en que vigente el token proporcionado por el SAT, para controlar si esta aun viente el token
var  REVISA = { VIGENCIATOKEN : 3, ESTADOREQ:20 }; // segundos
